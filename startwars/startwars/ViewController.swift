...
class ViewController: ScrollingNavigationViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchDisplayDelegate {
    ...
    func loadFirstSpecies() {
        ...
        StarWarsSpecies.getSpecies { wrapper, error in
            if let error = error
            {
                ...
                let alert = UIAlertController(title: "Error", message: "Could not load first species \(error.localizedDescription)", preferredStyle: UIAlertController.Style.alert)
    ...
    func loadMoreSpecies() {
        ...
        if self.species != nil && self.speciesWrapper != nil && self.species.count < self.speciesWrapper!.count
        {
            ...
            StarWarsSpecies.getMoreSpecies(self.speciesWrapper, completionHandler: { wrapper, error in
                ...
                {
                    self.isLoadingSpecies = false
                    let alert = UIAlertController(title: "Error", message: "Could not load more species \(error.localizedDescription)", preferredStyle: UIAlertController.Style.alert)
                    alert.addAction(UIAlertAction(title: "Click", style: UIAlertAction.Style.default, handler: nil))
                    self.present(alert, animated: true, completion: nil)
                }
                print("got more!")
    ...
    @objc func showScrollOptions() {
        ...
        // Scroll to Top
        let firstRowAction = UIAlertAction(title: "First Row", style: UIAlertAction.Style.default, handler: { (alert: UIAlertAction) in
        ...
        // Last Row
        let lastRowAction = UIAlertAction(title: "Last Row", style: UIAlertAction.Style.default, handler: { (alert: UIAlertAction) in
        ...
        // Selected Row
        let selectedRowAction = UIAlertAction(title: "Selected Row", style: UIAlertAction.Style.default, handler: { (alert: UIAlertAction) in
        ...
        // Above Header
        let topAction = UIAlertAction(title: "Header", style: UIAlertAction.Style.default, handler: { (alert: UIAlertAction) in
            self.scrollToHeader()
            self.dismiss(animated: true, completion: nil)
        });
